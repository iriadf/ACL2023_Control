...
if __name__ == '__main__':
	...
	out_file_names = [ 
		'output_acceptability_bertinho-base.csv', # Bertinho-base
		'output_acceptability_bertinho-small.csv', # Bertinho-small
		'output_acceptability_bert-base.csv', # BERT base
		'output_acceptability_bert-small.csv', # BERT small
		'output_acceptability_bert-base-multilingual-cased.csv', # mBERT
		'output_acceptability_xlm-roberta-base.csv', # XLM-RoBERTa-base
		'output_acceptability_xlm-roberta-large.csv', # XLM-RoBERTa-large
		] 
