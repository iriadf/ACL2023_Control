...
def run_experiment(in_file_name, out_file_name, model_name, dict_file, N):
	...
	for i in tqdm(ind):
		...
		top_5 = torch.topk(mask_logits, 5, dim=1) # returns the value of the top 5 elements on mask_tokens_logits and their idx
...
if __name__ == '__main__':
	...
	out_file_names = [ 
		'output_prediccion_roberta-large-bne.csv', # RoBERTa-large
		'output_prediccion_roberta-base-bne.csv', # RoBERTa-base
		'output_prediccion_bert-base-spanish-wwm-cased.csv', # BETO
		'output_prediccion_bert-base-multilingual-cased.csv', # mBERT
		'output_prediccion_xlm-roberta-base.csv', # XLM-RoBERTa-base
		'output_prediccion_xlm-roberta-large.csv', # XLM-RoBERTa-large
		] 

	for model_name, out_file_name in zip (model_names, out_file_names):
		print("\n============================================================================\n")
		print("Running experiment with model: " + model_name)
		run_experiment(in_file_name=in_file_name, out_file_name=out_file_name, model_name=model_name, dict_file = 'adjectives_spanish.txt', N = 100)
